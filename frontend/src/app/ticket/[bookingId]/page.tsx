      ...
      <div className="px-4 py-5 space-y-4">
        ...
        <div className="flex items-center gap-3 bg-green-50 border border-green-200 rounded-2xl p-4">
          ...
          <div>
            ...
            <p className="text-xs text-green-700">Ticket sent to your phone and email.</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
          ...
          <div className="bg-blue-700 text-white px-5 py-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="font-bold text-lg">TEGA.Rw</p>
                <p className="text-blue-200 text-xs">Digital Bus Ticket</p>
              </div>
              {ticket.is_used && (
                <span className="bg-blue-800 text-blue-200 text-xs px-2 py-1 rounded-full">Used</span>
              )}
            </div>
          </div>
          ...
          <div className="px-5 py-3 bg-blue-50 border-b border-blue-100">
            <p className="text-xs text-blue-500 font-semibold uppercase tracking-wide">Ticket Number</p>
            <p className="font-mono font-bold text-blue-900 text-base">{ticket.ticket_number}</p>
          </div>
          ...
          <div className="px-5 py-4 border-b border-dashed border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="font-bold text-gray-900 text-base">{ticket.departure_station}</p>
              </div>
              ...
              <div className="text-right">
                ...
                <p className="font-bold text-gray-900 text-base">{ticket.arrival_station}</p>
              </div>
            </div>
          </div>

          {/* Details grid */}
          <div className="px-5 py-4 grid grid-cols-2 gap-4 text-sm border-b border-dashed border-gray-200">
            <div>
              <p className="text-gray-400 text-xs uppercase tracking-wide">Passenger</p>
              <p className="font-semibold text-gray-900">{ticket.passenger_name}</p>
            </div>
            <div>
              <p className="text-gray-400 text-xs uppercase tracking-wide">Phone</p>
              <p className="font-semibold text-gray-900">{ticket.passenger_phone}</p>
            </div>
            <div>
            ...
            <div>
              <p className="text-gray-400 text-xs uppercase tracking-wide">Seat</p>
              <p className="font-semibold text-gray-900">#{ticket.seat_number}</p>
            </div>
            <div>
              <p className="text-gray-400 text-xs uppercase tracking-wide">Bus</p>
              <p className="font-semibold text-gray-900">{ticket.bus_name}</p>
            </div>
            <div>
              <p className="text-gray-400 text-xs uppercase tracking-wide">Plate</p>
              <p className="font-semibold text-gray-900">{ticket.plate_number}</p>
            </div>
          </div>

          {/* QR Code */}
          <div className="px-5 py-5 flex flex-col items-center gap-3">
            <p className="text-xs text-gray-400 uppercase tracking-wide">Scan at boarding</p>
            {ticket.qr_code_data ? (
